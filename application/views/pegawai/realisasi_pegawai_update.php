                    ...
                    <div class="row">
                        ...
                        <?= form_open('pegawai/input_realisasi/'.$realisasi); ?>
                            ...
                            <div class="form-group ">
                                ...
                                <input type="text" name="merkpembatas" class="form-control" required>
                                <label>Tipe Pembatas</label>
                                <input type="text" name="tipepembatas" class="form-control" required>
                                <label>Arus Pembatas</label>
                                <input type="text" name="aruspembatas" class="form-control" required>    
                            </div>   <hr>   
                            <div class="form-group ">
                            ...
                            <div class="form-group ">
                                ...
                                <input type="text" name="jenisct" class="form-control">     
                            </div> <hr>
                            <div class="form-group ">
